...
function loadProjects() {
    const projects = [
        ...
        },
        {
            ...
            tags: ['CSS Grid', 'JavaScript', 'MYSQL', 'HTML', 'PHP'],
    ...
    const experiences = [
        {
            ...
            description: [
                ...
                'Conhecimentos intermediários em diversas áreas de TI',
            ...
            technologies: ['HTML', 'CSS', 'JavaScript', 'Git', 'TI'],
        ...
        },
        {
            ...
            technologies: ['JavaScript', 'HTML5', 'CSS3', 'GitHub', 'Responsive Design', 'MYSQL', 'PHP'],
            icon: 'fas fa-users'
        }
    ];
